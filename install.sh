...
echo "  4. npx sandcastle docker build-image   # build the sandbox image (once per repo)"
echo "  5. 9router &   # start the gateway"
echo "  6. npx tsx .sandcastle/check-models.mts   # verify models + image"
echo "  7. nohup npm run sandcastle > .sandcastle/run.log 2>&1 &"
